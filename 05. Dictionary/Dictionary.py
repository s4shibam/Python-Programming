...
name_title = {"Shibam": "Saha", "Sunabha": "Panda", "Pranab Saha": {"Office": "Employee", "Batch": "Sir", "Home": "Son"}}
print(name_title)

name_title["Vicky"] = "Kaushal"     # Updating key pairs in selected array Type 1
print(name_title)

name_title["Katrina"] = "Kaif"  # Updating key pairs in selected array Type 1
print(name_title)

name_title.update({"Salman": "Khan"})   # Updating key pairs in selected array Type 2
print(name_title)
